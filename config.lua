...
Config.Defaults = {
    ['male'] = {
        ...
        ['facemix'] = { ['item'] = 0.0, ['texture'] = 0 },
        ['pants'] = { ['item'] = 0, ['texture'] = 0 },
        ['hair'] = { ['item'] = 0, ['texture'] = 0 },
        ['eyebrows'] = { ['item'] = 1, ['texture'] = 1 }, 
        ['beard'] = { ['item'] = -1, ['texture'] = 0 },
        ['blush'] = { ['item'] = -1, ['texture'] = 0 },
        ['lipstick'] = { ['item'] = -1, ['texture'] = 0 },
        ...
        ['jaw_bone_back_lenght'] = { ['item'] = 0, ['texture'] = 0 }, -- spelling mistake intentional
        ...
        ['neck_thikness'] = { ['item'] = 0, ['texture'] = 0 }, -- spelling mistake intentional
    },
    ['female'] = {
        ['face'] = { ['item'] = 27, ['texture'] = 0 },
        ['face2'] = { ['item'] = 27, ['texture'] = 0 },
        ['facemix'] = { ['item'] = 0.0, ['texture'] = 0 },
        ['pants'] = { ['item'] = 0, ['texture'] = 0 },
